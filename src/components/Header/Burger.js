						...
						<div className="bg-[#F9F5F2] p-4">
							<div className="flex flex-col items-center justify-center">
								<div className="flex gap-4 mb-2 text-sm">
                                    <button className="font-bold border-[#D2296F] border-2 text-[#D2296F]  uppercase rounded-full  px-8 py-2 bg-white">sign up</button>
                                    <button className="bg-[#D2296F] text-white font-bold  uppercase rounded-full  px-8 py-2">sign in</button>
                                </div>
                                <p className="text-xs font-medium opacity-80 mb-1">Not a DD Perks member?</p>
                                <span className="uppercase font-bold text-xs text-[#D2296F]">learn more</span>
							</div>
						</div>
